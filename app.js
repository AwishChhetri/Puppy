...
//     const promises = [];
//     const start = 580; // Start index
//     const end = Math.min(590, jsonData.length); // End index (limit to jsonData length)
...
// const sendEmails = async (jsonData) => {
//     const promises = [];
//     const start = 700; // Start index
//     const end = Math.min(701, jsonData.length); // End index (limit to jsonData length)
//     for (let i = start; i < end; i++) {
//         const item = jsonData[i];
//         const vtu = item.VTU;
//         const userEmail = `vtu${vtu}@veltech.edu.in`;
